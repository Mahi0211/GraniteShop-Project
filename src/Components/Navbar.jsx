...
const Navbar = () => {
  ...
  return (
    <div
      className={`rounded flex justify-between w-full py-10 px-6 fixed top-0 z-50 backdrop-blur-md bg-white/20 border-b border-white/30 transition-transform duration-300 ${
